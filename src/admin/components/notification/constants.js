import { AlertTriangle, Bell, BookOpen, CheckCircle2, PenTool, Shield, User, Users, XCircle } from "lucide-react";
...
export const TYPE_META = {
  ...
  author_request:  { icon: PenTool,       color: "bg-amber-500/12 text-amber-500",                             label: "Author Request",   category: "user" },
  author_registration: { icon: PenTool,   color: "bg-amber-500/12 text-amber-500",                             label: "Author Request",   category: "user" },
  author_registration_pending: { icon: PenTool, color: "bg-amber-500/12 text-amber-500",                       label: "Author Request",   category: "user" },
  author_approved: { icon: CheckCircle2,  color: "bg-emerald-500/12 text-emerald-500",                         label: "Author Approved",  category: "user" },
  author_rejected: { icon: XCircle,       color: "bg-rose-500/12 text-rose-500",                               label: "Author Rejected",  category: "user" },
