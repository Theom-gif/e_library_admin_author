...
const translations = {
  km: {
    ...
    "Author Portal": "វេទិកាអ្នកនិពន្ធ",
    "My Books": "សៀវភៅរបស់ខ្ញុំ",
    "Upload New": "បង្ហោះថ្មី",
    Analytics: "វិភាគ",
    Feedback: "មតិយោបល់",
    "Manage your account preferences and studio configuration.": "គ្រប់គ្រងចំណូលចិត្តគណនី និងការកំណត់ស្ទូឌីយោរបស់អ្នក។",
    Account: "គណនី",
    "Personal Information": "ព័ត៌មានផ្ទាល់ខ្លួន",
    "Update your name, email and bio": "ធ្វើបច្ចុប្បន្នភាពឈ្មោះ អ៊ីមែល និងប្រវត្តិរូបរបស់អ្នក",
    "Password & Security": "ពាក្យសម្ងាត់ និងសុវត្ថិភាព",
    "Manage your password and 2FA": "គ្រប់គ្រងពាក្យសម្ងាត់ និងការផ្ទៀងផ្ទាត់ពីរជាន់",
    Language: "ភាសា",
    Subscription: "ការជាវ",
    "Privacy Settings": "ការកំណត់ឯកជនភាព",
    "Control who sees your profile and works": "គ្រប់គ្រងថា នរណាអាចមើលប្រវត្តិរូប និងស្នាដៃរបស់អ្នក",
    "Email, push and in-app alerts": "សារជូនដំណឹងអ៊ីមែល, push និងក្នុងកម្មវិធី",
    "Please enter your name.": "សូមបញ្ចូលឈ្មោះរបស់អ្នក។",
    "Personal information updated successfully.": "បានធ្វើបច្ចុប្បន្នភាពព័ត៌មានផ្ទាល់ខ្លួនដោយជោគជ័យ។",
    "Unable to save profile. Please try again.": "មិនអាចរក្សាទុកប្រវត្តិរូបបានទេ។ សូមព្យាយាមម្តងទៀត។",
    "Security preferences saved successfully.": "បានរក្សាទុកចំណូលចិត្តសុវត្ថិភាពដោយជោគជ័យ។",
    "Language updated successfully.": "បានធ្វើបច្ចុប្បន្នភាពភាសាដោយជោគជ័យ។",
    "Privacy settings updated successfully.": "បានធ្វើបច្ចុប្បន្នភាពការកំណត់ឯកជនភាពដោយជោគជ័យ។",
    "Notification preferences saved successfully.": "បានរក្សាទុកចំណូលចិត្តការជូនដំណឹងដោយជោគជ័យ។",
    "Please fill in all password fields.": "សូមបំពេញគ្រប់វាលពាក្យសម្ងាត់។",
    "New password and confirmation do not match.": "ពាក្យសម្ងាត់ថ្មី និងការបញ្ជាក់មិនត្រូវគ្នាទេ។",
    "Password update failed.": "ការធ្វើបច្ចុប្បន្នភាពពាក្យសម្ងាត់បរាជ័យ។",
    "Unable to update password. Please try again.": "មិនអាចធ្វើបច្ចុប្បន្នភាពពាក្យសម្ងាត់បានទេ។ សូមព្យាយាមម្តងទៀត។",
    "Back to Settings": "ត្រឡប់ទៅការកំណត់",
    Name: "ឈ្មោះ",
    "Your name": "ឈ្មោះរបស់អ្នក",
    Bio: "ប្រវត្តិរូប",
    "Tell readers about yourself...": "ប្រាប់អ្នកអានអំពីអ្នក...",
    "Saving...": "កំពុងរក្សាទុក...",
    "Save Changes": "រក្សាទុកការផ្លាស់ប្តូរ",
    Password: "ពាក្យសម្ងាត់",
    "Change your password and keep your account secure.": "ប្តូរពាក្យសម្ងាត់ និងរក្សាគណនីឲ្យមានសុវត្ថិភាព។",
    "Updating...": "កំពុងធ្វើបច្ចុប្បន្នភាព...",
    "Two-factor authentication": "ការផ្ទៀងផ្ទាត់ពីរជាន់",
    "Add an extra layer of security to your account.": "បន្ថែមស្រទាប់សុវត្ថិភាពបន្ថែមសម្រាប់គណនីរបស់អ្នក។",
    "Save Security": "រក្សាទុកសុវត្ថិភាព",
    "Public profile": "ប្រវត្តិរូបសាធារណៈ",
    "Allow readers to see your author profile.": "អនុញ្ញាតឲ្យអ្នកអានមើលប្រវត្តិរូបអ្នកនិពន្ធរបស់អ្នក។",
    "Show email to readers": "បង្ហាញអ៊ីមែលទៅអ្នកអាន",
    "Display your email on your public profile.": "បង្ហាញអ៊ីមែលរបស់អ្នកនៅលើប្រវត្តិរូបសាធារណៈ។",
    "Show reading stats": "បង្ហាញស្ថិតិការអាន",
    "Share book performance with readers.": "ចែករំលែកលទ្ធផលសៀវភៅជាមួយអ្នកអាន។",
    "Save Privacy": "រក្សាទុកឯកជនភាព",
    "Email alerts": "ការជូនដំណឹងតាមអ៊ីមែល",
    "Receive updates and approvals by email.": "ទទួលការធ្វើបច្ចុប្បន្នភាព និងការអនុម័តតាមអ៊ីមែល។",
    "Push notifications": "ការជូនដំណឹងបញ្ចូន",
    "Get instant alerts on your device.": "ទទួលការជូនដំណឹងភ្លាមៗលើឧបករណ៍របស់អ្នក។",
    "In-app notifications": "ការជូនដំណឹងក្នុងកម្មវិធី",
    "Show alerts inside the portal.": "បង្ហាញការជូនដំណឹងនៅក្នុងប្រព័ន្ធ។",
    "Selected Setting": "ការកំណត់ដែលបានជ្រើស",
    "Need help?": "ត្រូវការជំនួយ?",
    "Check our documentation or contact support for assistance.": "ពិនិត្យឯកសារណែនាំ ឬទាក់ទងក្រុមគាំទ្រសម្រាប់ជំនួយ។",
    "Contact Support": "ទាក់ទងក្រុមគាំទ្រ",
    "Contact Admin\n\nBenefits of contacting the admin:\n- Fast help with account issues\n- Approval and publishing support\n- Access to system settings\n- Reliable updates and announcements\n\nReach the admin via the official support channel.": "ទាក់ទងអ្នកគ្រប់គ្រង\n\nអត្ថប្រយោជន៍នៃការទាក់ទងអ្នកគ្រប់គ្រង:\n- ជំនួយលឿនសម្រាប់បញ្ហាគណនី\n- ការគាំទ្រការអនុម័ត និងបោះពុម្ពផ្សាយ\n- ចូលដំណើរការការកំណត់ប្រព័ន្ធ\n- ការធ្វើបច្ចុប្បន្នភាព និងការជូនដំណឹងដែលអាចទុកចិត្តបាន\n\nទាក់ទងអ្នកគ្រប់គ្រងតាមឆានែលគាំទ្រផ្លូវការ។",
  },
  zh: {
    "Admin Portal": "管理门户",
    Dashboard: "仪表盘",
    ...
    Analytics: "数据分析",
    Feedback: "反馈",
    "Manage your account preferences and studio configuration.": "管理你的账户偏好和工作室配置。",
    Account: "账户",
    "Personal Information": "个人信息",
    "Update your name, email and bio": "更新你的姓名、邮箱和简介",
    "Password & Security": "密码与安全",
    "Manage your password and 2FA": "管理你的密码和双重认证",
    Language: "语言",
    Subscription: "订阅",
    "Privacy Settings": "隐私设置",
    "Control who sees your profile and works": "控制谁可以查看你的资料和作品",
    "Email, push and in-app alerts": "邮件、推送和应用内提醒",
    "Please enter your name.": "请输入你的姓名。",
    "Personal information updated successfully.": "个人信息更新成功。",
    "Unable to save profile. Please try again.": "无法保存资料，请重试。",
    "Security preferences saved successfully.": "安全偏好保存成功。",
    "Language updated successfully.": "语言更新成功。",
    "Privacy settings updated successfully.": "隐私设置更新成功。",
    "Notification preferences saved successfully.": "通知偏好保存成功。",
    "Please fill in all password fields.": "请填写所有密码字段。",
    "New password and confirmation do not match.": "新密码与确认密码不一致。",
    "Password update failed.": "密码更新失败。",
    "Unable to update password. Please try again.": "无法更新密码，请重试。",
    "Back to Settings": "返回设置",
    Name: "姓名",
    "Your name": "你的姓名",
    Bio: "简介",
    "Tell readers about yourself...": "向读者介绍你自己...",
    "Saving...": "保存中...",
    "Save Changes": "保存更改",
    Password: "密码",
    "Change your password and keep your account secure.": "修改密码以确保账户安全。",
    "Updating...": "更新中...",
    "Two-factor authentication": "双重认证",
    "Add an extra layer of security to your account.": "为账户增加额外的安全保护。",
    "Save Security": "保存安全设置",
    "Public profile": "公开资料",
    "Allow readers to see your author profile.": "允许读者查看你的作者资料。",
    "Show email to readers": "向读者显示邮箱",
    "Display your email on your public profile.": "在公开资料中显示你的邮箱。",
    "Show reading stats": "显示阅读统计",
    "Share book performance with readers.": "与读者分享书籍表现。",
    "Save Privacy": "保存隐私设置",
    "Email alerts": "邮件提醒",
    "Receive updates and approvals by email.": "通过邮件接收更新和审核结果。",
    "Push notifications": "推送通知",
    "Get instant alerts on your device.": "在设备上即时收到提醒。",
    "In-app notifications": "应用内通知",
    "Show alerts inside the portal.": "在门户内显示提醒。",
    "Selected Setting": "已选择的设置",
    "Need help?": "需要帮助？",
    "Check our documentation or contact support for assistance.": "查看文档或联系支持获取帮助。",
    "Contact Support": "联系支持",
    "Contact Admin\n\nBenefits of contacting the admin:\n- Fast help with account issues\n- Approval and publishing support\n- Access to system settings\n- Reliable updates and announcements\n\nReach the admin via the official support channel.": "联系管理员\n\n联系管理员的好处：\n- 快速解决账户问题\n- 审核与发布支持\n- 访问系统设置\n- 可靠的更新与公告\n\n请通过官方支持渠道联系管理员。",
  },
};
