...
export const TYPE_META = {
  ...
  "author.pending_approval": { icon: User, color: "bg-amber-500/12 text-amber-500",                            label: "Author Request",   category: "user" },
  author_request_pending:  { icon: User,          color: "bg-amber-500/12 text-amber-500",                             label: "Author Request",   category: "user" },
  author_request_approved: { icon: User,          color: "bg-emerald-500/12 text-emerald-500",                         label: "Author Approved",  category: "user" },
  author_request_rejected: { icon: AlertTriangle, color: "bg-rose-500/12 text-rose-500",                               label: "Author Rejected",  category: "user" },
